...
namespace EcoLens.Api.Migrations
{
    ...
    [Migration("20260128073007_AddTreeStateFields")]
    partial class AddTreeStateFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EcoLens.Api.Models.CarbonReference", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Category = 0,
                            Co2Factor = 27.0m,
                            CreatedAt = new DateTime(2026, 1, 28, 7, 30, 7, 89, DateTimeKind.Utc).AddTicks(6397),
                            LabelName = "Beef",
                            Source = "Local",
                            Unit = "kgCO2",
                            UpdatedAt = new DateTime(2026, 1, 28, 7, 30, 7, 89, DateTimeKind.Utc).AddTicks(6402)
                        },
                        new
                        {
                            Id = 2,
                            Category = 1,
                            Co2Factor = 0.03m,
                            CreatedAt = new DateTime(2026, 1, 28, 7, 30, 7, 89, DateTimeKind.Utc).AddTicks(6412),
                            LabelName = "Subway",
                            Source = "Local",
                            Unit = "kgCO2/km",
                            UpdatedAt = new DateTime(2026, 1, 28, 7, 30, 7, 89, DateTimeKind.Utc).AddTicks(6412)
                        },
                        new
                        {
                            Id = 3,
                            Category = 2,
                            Co2Factor = 0.5m,
                            CreatedAt = new DateTime(2026, 1, 28, 7, 30, 7, 89, DateTimeKind.Utc).AddTicks(6415),
                            LabelName = "Electricity",
                            Source = "Local",
                            Unit = "kgCO2/kWh",
                            UpdatedAt = new DateTime(2026, 1, 28, 7, 30, 7, 89, DateTimeKind.Utc).AddTicks(6415)
                        },
                        new
                        {
                            Id = 4,
                            Category = 2,
                            Co2Factor = 0.35m,
                            CreatedAt = new DateTime(2026, 1, 28, 7, 30, 7, 89, DateTimeKind.Utc).AddTicks(6417),
                            LabelName = "Water",
                            Source = "Local",
                            Unit = "kgCO2/m3",
                            UpdatedAt = new DateTime(2026, 1, 28, 7, 30, 7, 89, DateTimeKind.Utc).AddTicks(6418)
                        },
                        new
                        {
                            Id = 5,
                            Category = 2,
                            Co2Factor = 2.3m,
                            CreatedAt = new DateTime(2026, 1, 28, 7, 30, 7, 89, DateTimeKind.Utc).AddTicks(6420),
                            LabelName = "Gas",
                            Source = "Local",
                            Unit = "kgCO2/unit",
                            UpdatedAt = new DateTime(2026, 1, 28, 7, 30, 7, 89, DateTimeKind.Utc).AddTicks(6421)
                        });
                });
