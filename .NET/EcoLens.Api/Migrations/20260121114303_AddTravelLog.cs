...
{
    /// <inheritdoc />
    public partial class AddTravelLog : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "Category", "Co2Factor", "CreatedAt", "LabelName", "Unit", "UpdatedAt" },
                values: new object[,]
                {
                    { 1, 0, 27.0m, new DateTime(2026, 1, 21, 11, 43, 2, 921, DateTimeKind.Utc).AddTicks(155), "Beef", "kgCO2", new DateTime(2026, 1, 21, 11, 43, 2, 921, DateTimeKind.Utc).AddTicks(161) },
                    { 2, 1, 0.03m, new DateTime(2026, 1, 21, 11, 43, 2, 921, DateTimeKind.Utc).AddTicks(169), "Subway", "kgCO2/km", new DateTime(2026, 1, 21, 11, 43, 2, 921, DateTimeKind.Utc).AddTicks(170) },
                    { 3, 2, 0.5m, new DateTime(2026, 1, 21, 11, 43, 2, 921, DateTimeKind.Utc).AddTicks(172), "Electricity", "kgCO2/kWh", new DateTime(2026, 1, 21, 11, 43, 2, 921, DateTimeKind.Utc).AddTicks(172) },
                    { 4, 1, 0m, new DateTime(2026, 1, 21, 11, 43, 2, 921, DateTimeKind.Utc).AddTicks(174), "Walking", "kgCO2/km", new DateTime(2026, 1, 21, 11, 43, 2, 921, DateTimeKind.Utc).AddTicks(174) },
                    { 5, 1, 0m, new DateTime(2026, 1, 21, 11, 43, 2, 921, DateTimeKind.Utc).AddTicks(176), "Bicycle", "kgCO2/km", new DateTime(2026, 1, 21, 11, 43, 2, 921, DateTimeKind.Utc).AddTicks(177) },
                    { 6, 1, 0.02m, new DateTime(2026, 1, 21, 11, 43, 2, 921, DateTimeKind.Utc).AddTicks(178), "ElectricBike", "kgCO2/km", new DateTime(2026, 1, 21, 11, 43, 2, 921, DateTimeKind.Utc).AddTicks(178) },
                    { 7, 1, 0.05m, new DateTime(2026, 1, 21, 11, 43, 2, 921, DateTimeKind.Utc).AddTicks(180), "Bus", "kgCO2/km", new DateTime(2026, 1, 21, 11, 43, 2, 921, DateTimeKind.Utc).AddTicks(180) },
                    { 8, 1, 0.2m, new DateTime(2026, 1, 21, 11, 43, 2, 921, DateTimeKind.Utc).AddTicks(181), "Taxi", "kgCO2/km", new DateTime(2026, 1, 21, 11, 43, 2, 921, DateTimeKind.Utc).AddTicks(182) },
                    { 9, 1, 0.2m, new DateTime(2026, 1, 21, 11, 43, 2, 921, DateTimeKind.Utc).AddTicks(183), "CarGasoline", "kgCO2/km", new DateTime(2026, 1, 21, 11, 43, 2, 921, DateTimeKind.Utc).AddTicks(184) },
                    { 10, 1, 0.05m, new DateTime(2026, 1, 21, 11, 43, 2, 921, DateTimeKind.Utc).AddTicks(185), "CarElectric", "kgCO2/km", new DateTime(2026, 1, 21, 11, 43, 2, 921, DateTimeKind.Utc).AddTicks(185) },
                    { 11, 1, 0.04m, new DateTime(2026, 1, 21, 11, 43, 2, 921, DateTimeKind.Utc).AddTicks(187), "Train", "kgCO2/km", new DateTime(2026, 1, 21, 11, 43, 2, 921, DateTimeKind.Utc).AddTicks(187) },
                    { 12, 1, 0.25m, new DateTime(2026, 1, 21, 11, 43, 2, 921, DateTimeKind.Utc).AddTicks(188), "Plane", "kgCO2/km", new DateTime(2026, 1, 21, 11, 43, 2, 921, DateTimeKind.Utc).AddTicks(189) }
                });
